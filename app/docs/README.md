...
| 17 | [17-le-quattro-opzioni-e-i-debiti-di-misura.md](17-le-quattro-opzioni-e-i-debiti-di-misura.md) | quali opzioni del client si accendono per misurare, perché il confronto fra architetture esce con due numeri invece di uno, come ci si accorge che il numero misurava il client, e la quinta opzione — il write concern — con cui il Task 18 ha scoperto che il giornale costa più della maggioranza |
