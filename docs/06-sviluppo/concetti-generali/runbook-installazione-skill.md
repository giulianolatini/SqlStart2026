...
| 2026-09-06 | Claude Code, ramo `release/1.0` di SqlStart2026 | Installazione **di progetto** delle dodici skill (commit `65385ec`, verbatim), copia verificata con `diff -r` e passata al setaccio dei segreti. Collaudo con le tre suite delle skill: 127 prove, tutte passate. Runbook esteso con «Il caso di SqlStart2026» |
